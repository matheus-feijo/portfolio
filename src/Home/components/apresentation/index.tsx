  ...
  return (
    <div className="container-apresentation grid place-items-center h-[100vh] w-full">
      <div>
        <p
          className={`${
            navigator.userAgent.search("Firefox") >= 0 && "firefox-title"
          } typing-animation leading-relaxed whitespace-nowrap overflow-hidden select-none`}
        >
          Eu sou o Matheus Feijó
        </p>
        <p className="subtitle-apresentation whitespace-nowrap overflow-hidden">
      ...
      <div className="flex gap-8">
        <button className="h-20 w-20">
          <a
            href="https://github.com/matheus-feijo"
            target="_blank"
            rel="noreferrer"
          >
