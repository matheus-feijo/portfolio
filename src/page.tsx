    ...
    <>
      ...
      >
        <div>
          ...
          <h3 className="whitespace-nowrap overflow-hidden animate-subtitle-view text-2xl opacity-70 mobile:text-lg">
            Desenvolvedor de Software
          </h3>
        </div>

        <div>
          <button className="animate-more-details" onClick={handleOpenModal}>
            Mais detalhes
          </button>
        </div>
